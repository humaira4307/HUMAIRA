...
if is_equal(llist1,llist2):
    print('The llist1 is equal to llist2')
elif is_greater(llist1, llist2):
    print('The llist1 is greater than llist2.')
else:
    print('The llist1 is not greater than llist2', end = '')
